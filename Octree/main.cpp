...
Octree *octavius;// = new Octree(pointOctree(-50, 50), pointOctree(50, -50), pointOctree(50, -50), 2);
...
int main(int argc, char** argv) {
	...
	octavius = new Octree(pointOctree(-50, 50), pointOctree(50, -50), pointOctree(50, -50), 2);
	//qt = new quadTree();
